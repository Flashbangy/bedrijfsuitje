                            ...
                            <div class="panel-body">
                                <form method="POST" action="">
                                    <div class="form-group">
                                        ...
                                        <input name="voorletters" type="text" class="form-control" value="Voorletters">
                                    </div>
                                    <div class="form-group">
                                        <label>Tussenvoegsel</label>
                                        <input name="tussenvoegsel" type="text" class="form-control" value="Tussenvoegsel">
                                    </div>
                                    <div class="form-group">
                                        <label>Achternaam</label>
                                        <input name="achternaam" type="text" class="form-control" value="Achternaam">
                                    </div>
                                    <div class="form-group">
                                        <label>E-Mail</label>
                                        <input name="email" type="text" class="form-control" value="E-Mail">
                                    </div>
                                    <div class="form-group">
